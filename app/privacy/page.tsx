    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 font-sans selection:bg-blue-500/30 flex flex-col">
      ...
      <main className="flex-grow pt-40 pb-24 px-6 max-w-4xl mx-auto w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none text-zinc-600 dark:text-zinc-400">
          ...
          <p className="mt-6">
            At RateAI, your data privacy is our absolute priority. We employ strict sanitization protocols 
            to ensure that no personally identifiable information (PII) is leaked during the execution 
            of AI stack audits.
          </p>
          <h2 className="text-xl font-black text-zinc-900 dark:text-white mt-8 mb-4">1. Data Collection</h2>
          <p>
            We collect the inputs provided during the audit process, including tool selections, team size, 
            and budget parameters. When you capture an email lead, it is securely stored in our encrypted 
            Supabase database and is never shared with third-party LLM providers.
          </p>
          <h2 className="text-xl font-black text-zinc-900 dark:text-white mt-8 mb-4">2. Public Audits</h2>
          <p>
            When generating a shareable audit, all proprietary identifiers and email associations are 
            stripped prior to sharing. The resulting public URL contains only anonymized financial insights.
          </p>
        </div>
      </main>
